...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edtMnCollateralTx.setToolTip(_translate("MainWindow", "The collateral transaction hash from the 7500 ZYRK deposit"))
        self.label_7.setText(_translate("MainWindow", "TX index:"))
        self.edtMnCollateralTxIndex.setToolTip(_translate("MainWindow", "The collateral transaction\'s (unspent) output index with the 7500 ZYRK deposit (usally 0)"))
        self.edtMnCollateralAddress.setToolTip(_translate("MainWindow", "Zyrk address of the 7500 ZYRK collateral, coverted from BIP32 path with hardware wallet."))
        self.edtMnCollateralAddress.setPlaceholderText(_translate("MainWindow", "Zyrk address"))
        self.btnHwAddressToBip32.setToolTip(_translate("MainWindow", "Convert Zyrk address to BIP32 path using hardware wallet"))
        self.btnHwBip32ToAddress.setToolTip(_translate("MainWindow", "Convert BIP32 path to Zyrk address using hardware wallet"))
        self.edtMnCollateralBip32Path.setToolTip(_translate("MainWindow", "BIP32 path of the 7500 ZYRK collateral (e.g. 44\'/5\'/0\'/0/0)"))
        ...
        self.label_9.setText(_translate("MainWindow", "Masternode private key:"))
        ...
        self.action_check_network_connection.setToolTip(_translate("MainWindow", "Check Zyrk Network Connection"))
